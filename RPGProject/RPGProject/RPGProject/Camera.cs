...
namespace RPGProject
{
	...
	public class Camera
	{
        private int amplificateur = 1; // pour ajutster la vitesse de relévement / abaissement de la tête pour compenser la distance
		private int rayonview = 50;
		public int vit = 1;
		public float angle = 0;
		public int hview = 0;
        public int sensibilite = 5;
