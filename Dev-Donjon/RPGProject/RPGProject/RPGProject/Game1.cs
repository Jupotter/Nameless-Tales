...
namespace RPGProject
{
    ...
    #region variable
        ...
        protected override void Initialize()
		{
            ...
            water.DrawOrder = 100;
            skybox.DrawOrder = 100;
            trees.DrawOrder = 100;
            actualGround.DrawOrder = 100;

            dungeon.Add(d);

            CurrentWorldSpace = world;
            world.Load();
		...
		protected override void Update(GameTime gameTime)
		{
            ...
            Tools.Quick.player.position = camera.position;
            mousy.actualise();
            Tools.Quick.player.showsee();
        ...
        protected override void Draw(GameTime gameTime)
		{
            ...
            water.DrawReflectionMap(skybox);
